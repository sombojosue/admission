...
<html lang="en" dir="ltr">
   ...
   <div class="mobile_menu">
     ...
     <div class="menu_mobile_responsible">
       <ul>
         ...
         <li><a href="campus.php" id="active">Campus</a></li>
 ...
 <!-- Main contain -->
 <main class="body_campus">
  <div class="slider_contact" id="slider">
    <SCRIPT TYPE="text/javascript">
    <!--
  ...
  <br />
  <!-- College information -->
  <section class="container college_detail">
  <div class="col-md-12 owl-carousel owl-theme" id="college_top">
    <div class="row">
      <!-- First college -->

      <div class="testimoni-header">
        <img src="images/college_1.jpg" alt="" class="" id="img_campus">
        <br>
      </div>
      <div class="campus-detail-customer" id="text_campus">
        <br />
        <div id="start-text">
          ...
          <i class="far fa-star"></i>
          <i class="far fa-star"></i>
          <h2>Karnataka college of management and science</h2>
        </div>
       </div>
      </div>
     <!-- Second testimoni -->
     <div class="row">
       <div class="testimoni-header">
         <img src="images/college_2.jpg" alt="" class="" id="img_campus">
         <br>
       </div>
       <div class="campus-detail-customer" id="text_campus">
         <br />
     ...
     <div class="row">
       ...
       <div class="testimoni-header">
         <img src="images/college_3.jpg" alt="" class="" id="img_campus">
         <br>
       </div>
       <div class="campus-detail-customer" id="text_campus">
         <br />
...
<!-- End of college section -->
  <div class="campus_detail container">
      <br>
     <h1>Our campus</h1>
     <hr>
     <br>
     <div class="row">
      <div class="col-md-3">
      	<img src="img/campus_1.jpg">
      </div>
      <div class="col-md-3">
      	<img src="img/campus_2.jpg">
      </div>
      <div class="col-md-3">
      	<img src="img/campus_3.jpg">
      </div>
      <div class="col-md-3">
      	<img src="images/library.jpg" height="171px">
      </div>
  </div>
  <!-- second line in campus -->
  <br>
  <div class="row">
      <div class="col-md-3">
      	<img src="images/campus_5.jpg">
      </div>
      <div class="col-md-3">
      	<img src="images/campus_6.jpg">
      </div>
      <div class="col-md-3">
      	<img src="images/campus_7.jpg">
      </div>
      <div class="col-md-3">
      	<img src="images/campus_8.jpg">
      </div>
  </div>
</div>
 </main>
...
?>
 ...
 <section id="mobile_hide_footer">
   <div class="news">
    ...
    <form  action="" method="post">
      <input type="text" name="name" id="name" value="" required placeholder="name" class="form-control">
      <input type="email" name="email" id="email" required value="" placeholder="email" class="form-control">
 ...
 <footer class="footer">
   <div class="news">
    ...
    <form  action="" method="post">
      <input type="text" name="name" id="Name" required placeholder="name" style="border:1px solid lightgray;border-radius:5px;padding:5px;font-size:18px;">
      <input type="email" name="email"  id="Email" required placeholder="email" style="border:1px solid lightgray;border-radius:5px;padding:5px;font-size:18px;">
   ...
   <div class="menu_footer">
     <div class="menu_foot">
       <ul>
         <li><a href="index.php">Home</a></li>
         <li><a href="campus.php" id="active_footer">Campus</a></li>
         <li><a href="course.php">Courses</a></li>
         <li><a href="about.php">About</a></li>
         <li><a href="contact.php">Contact</a></li>
         <li><a href="admission.php">Admission</a></li>
