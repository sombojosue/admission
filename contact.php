...
<html lang="en" dir="ltr">
 ...
 <main class="body_contact">
  <div class="slider_contact">
    ...
    <P>
    <P>
    <IMG SRC="images/karna.jpg" ALT="slideshow image"><BR>
  ...
  <div class="service_contact container">
    <div class="row">
     <div class="info_contact col-md-3 space_left">
      <span class="size_contact">
      <i class="fas fa-phone-square-alt"></i>
      </span>
      <h4>Phone</h4>
      <p>9987310771 - 9987310771</p>
    </div>
    <div class="info_contact col-md-3">
        <span class="size_contact">
        <i class="fas fa-envelope"></i>
        </span>
        <h4>Email</h4>
        <p style="position:relative;left:-6px;text-align:center;">admissionrequestinfo@proton<br />mail.com</p>
    </div>
    <div class="info_contact col-md-3">
      <span class="size_contact">
      ...
      <h4>Address</h4>
      <p>Indian Institute, MG Road, Bangalore</p>
    </div>
  </div>
  </div>
  <div class="form_contact_info container">
    <div class="row">
    <div class="form_contact space_left col-md-5">
     <div class="form_contact_space">
     <h2 id="contact">Contact Us</h2>
     <p>Get in touch with us</p>
      <p id="contact_error"></p>
     <form class="" action="" method="post" name="news">
     <input type="text" name="name" required id="name_news" placeholder="Name">
     <input type="email" name="email" required id="email_news" placeholder="Email">
     <textarea name="message" id="message_news" placeholder=" Message"></textarea>
     <input type="submit" name="contact" value="Send">
   </form>
   </div>
   <!-- Send data into the databases -->
   <?php
if (isset($_POST['contact'])) {
  ...
  $email_query = "select email from contact where email = '$email_sql'";
  $res_email = mysqli_query($con, $email_query);
  if (mysqli_num_rows($res_email) > 0) {
    echo "<script>alert('Thanks you already contact us')</script>";
    echo "<script>window.location = 'index.php'</script>";
  }
  else
  {
  /* If email never find inside the database */
  $sql_query = "insert into contact(name,email,message) values('$name_sql','$email_sql','$message_sql')";
  $res = mysqli_query($con, $sql_query);
  if ($res) {
    echo "<script>alert('Thanks to contact us')</script>";
  }else{
...
?>
  ...
  <div class="form_contact col-md-5">
   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1678065.4773773907!2d76.84527975908212!3d12.343185719601827!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBengaluru%2C+Karnataka!5e0!3m2!1sen!2sin!4v1563085011126!5m2!1sen!2sin" width="460" height="480" frameborder="0" style="border:0" allowfullscreen></iframe>
  </div>
  </div>
</div>
 </main>
 ...
 <section id="mobile_hide_footer">
   <div class="news">
    ...
    <form  action="" method="post">
      ...
      <input type="email" name="email" required id="email" value="" placeholder="email" class="form-control">
...
<script src="js/owl.carousel.min.js"></script>
 ...
 <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
  ...
  $res = mysqli_query($con, $sql_query);
  if ($res) {
    echo "<script>alert('Thanks to contact we will replay soon')</script>";
  }else{
    echo "Ooof sorry brother ...";
  }
  */
  ?>