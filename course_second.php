 ...
 <main class="body_course">
   ...
   <div class="course_contain">
     <div class="course_title">
       ...
       <p id="cour_p">Easy learn provide a greatest courses in the world</p>
     </div>
     <!-- PHARMA SECTION -->
     <div class="">
      <div class="course_detail">
      <div class="course_image_left">
        <img src="images/pharma.jpg" alt="" width="" height="">
      </div>
      <div class="course_text_right">
        ...
        <a href="admission.php" id="course">Enrol</a> &nbsp; &nbsp; &nbsp; &nbsp;<a href="course_second.php#pharma" id="pharmabtn" onclick="displaypharma()">Detail</a>
     ...
     <div class="course_detail">
      <div class="course_image_left">
        <img src="images/nurse.jpg" alt="" width="" height="">
      </div>
      <div class="course_text_right">
       <h3> Bachelor of Science in Nursing</h3>
       <h5> B.Sc Nursing</h5>
       <p id="cour_p">B.sc Nursing can specialize in psychiatry, Medical-Surgical, Community Health and Paediatrics, Obstetrics and Gynaecology. After finishing BSc in Nursing they can opt for MSc in nursing.</p>
        <a href="admission.php" id="course">Enrol</a> &nbsp; &nbsp; &nbsp; &nbsp;<a href="course_second.php#nurse" id="nursebtn" onclick="displaynurse()">Detail</a>
       <div style="color:orange;margin-top:12px;">
         <i class="far fa-star"></i>
         <i class="far fa-star"></i>
         <i class="far fa-star"></i>
     ...
     <br>
     <!-- NURSE course details -->
     <div id="nurse">
       <h3>NURSING Course Details</h3>
       <table class="table tble-hover">
         <tr>
           <td>Course</td>
           <td>NURSING</td>
     ...
     <div class="course_detail">
      <div class="course_image_left">
        <img src="images/mba.jpg" alt="" width="" height="">
      </div>
      <div class="course_text_right">
       <h3>Master of Business Administration</h3>
       <h5>MBA</h5>
       <p id="cour_p">MBA is an Internationally accepted master of post-graduate level degree. The core courses in an MBA program cover various areas of business such as accounting, finance, marketing.</p>
       <a href="admission.php" id="course">Enrol</a> &nbsp; &nbsp; &nbsp; &nbsp;<a href="course_second.php#mba" id="mbabtn" onclick="displaymba()">Detail</a>
       <div style="color:orange;margin-top:12px;">
         <i class="far fa-star"></i>
         <i class="far fa-star"></i>
         <i class="far fa-star"></i>
   ...
   <!-- B science SECTION -->
   <div class="course_detail" id="IngHide">
    <div class="course_image_left">
      <img src="images/bsc.jpeg" alt="" width="" height="">
    </div>
    <div class="course_text_right">
     <h3>Bachelor of Science</h3>
     <h5>Bsc</h5>
     <p id="cour_p">Bachelor of Science [B.Sc] is an academic degree which is awarded to students graduating in the field of Science. It is one of the most popularly pursued courses in India. In India, the duration of the B.Sc course is 3 years.</p>
     <a href="admission.php" id="course">Enrol</a> &nbsp; &nbsp; &nbsp; &nbsp;<a href="coursesearch.php" id="pharmabtn">Detail</a>
     <div style="color:orange;margin-top:12px;">
       <i class="far fa-star"></i>
       <i class="far fa-star"></i>
       <i class="far fa-star"></i>
